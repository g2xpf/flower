...
interface MainProps extends MuiBoxProps {
  open?: boolean;
}
...
const Main = styled(Box, {
  ...
  width: open
    ? `calc(100% - ${openedMixin(theme).width}px)`
    : `calc(100% - ${closedMixin(theme).width})`,
  transition: theme.transitions.create(["width", "margin"], {
    easing: theme.transitions.easing.sharp,
    duration: theme.transitions.duration.enteringScreen,
  }),
    ...
    <Box id="app" sx={{ display: "flex" }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <ListItem button>
          ...
          <ListItemText>Flower Editor</ListItemText>
        </ListItem>
      </Drawer>
      <Main open={open} sx={{ flexGrow: 1, p: 0 }}>
        <DrawerHeader />
        <Divider />
        <AppBox component="main">
          <FlowerEditor />
        </AppBox>
      </Main>
    </Box>
